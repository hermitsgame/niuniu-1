(function(global, undefined){
    ...
    Contacts.prototype = {
        ...
        generateListItem: function(item){
            ...
            // var tpl = '<div class="logo"><img src="' + item.logo +'"></img></div><p class="name" pid="'+item.id+'">'+ item.name + '</p><p class="url">'+ item.url + '</p><input type="hidden" class="pid" value="'+item.id+'"/>';
            var tpl = '<div class="logo"><img src=""></img></div><p class="name" pid="'+item.id+'">'+ item.name + '</p><p class="url">'+ item.url + '</p><input type="hidden" class="pid" value="'+item.id+'"/>';
